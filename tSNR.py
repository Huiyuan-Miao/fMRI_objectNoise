...
ref_func_Preprocessed = '/home/tonglab/Miao/fMRI/rapid_event_related_object_noise/fMRI/data/individual/'+subject+'/'+session+'/functional/resting_state/run01/outputs/'+topup+'/noB0/preprocessing.feat/filtered_func_data.nii.gz'
...
# run analysis
if not os.path.isfile(ref_func_Preprocessed):
